...
cd /home/${linuxuser}
git clone git@bitbucket.org:mechanicalTA/agora.git
git config --global user.name "Farzad Abdolhosseini"  # Obviously, you should write your name here instead!
git config --global user.email "farzad.abdolhosseini@gmail.com"
cd agora
git checkout devel
